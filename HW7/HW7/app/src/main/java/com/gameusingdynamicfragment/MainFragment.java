...
public class MainFragment extends Fragment {
    ...
    public void ResultOneRoundDice() {
        ...
        switch (number / 2) {
            case 0:
                Toast.makeText(getContext(), getString(R.string.you_win), Toast.LENGTH_SHORT).show();
                miCountPlayerWin += 1;
                break;
            case 1:
                Toast.makeText(getContext(), getString(R.string.you_draw), Toast.LENGTH_SHORT).show();
                miCountDraw += 1;
                break;
            case 2:
                Toast.makeText(getContext(), getString(R.string.you_lose), Toast.LENGTH_SHORT).show();
                miCountComWin += 1;
                break;
        }
