...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mTxtComputerPlay, mTxtResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTxtComputerPlay = (TextView)findViewById(R.id.txtComPlay);
    ...
    private View.OnClickListener btnScissorsOnClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            mTxtComputerPlay.setText(cp.getComputerPlay(iComPlay));
            mTxtResult.setText(cp.Result(1,iComPlay));
        }
    };
    ...
    private View.OnClickListener btnStoneOnClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            int iComPlay = (int)(Math.random()*3 + 1);
            mTxtComputerPlay.setText(cp.getComputerPlay(iComPlay));
            mTxtResult.setText(cp.Result(2,iComPlay));
        }
    };
    ...
    private View.OnClickListener btnPaperOnClick = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            int iComPlay = (int)(Math.random()*3 + 1);
            mTxtComputerPlay.setText(cp.getComputerPlay(iComPlay));
            mTxtResult.setText(cp.Result(3,iComPlay));
        }
    };
}
